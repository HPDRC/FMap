...
//class /*CArray<CShape*> */CShapePtrArray
//{
//public:
//	CShapePtrArray(void);
//public:
//	virtual ~CShapePtrArray(void);
//public:
//	CShapePtrArray(const CArray<CShape*>& data)
//
//}
...
public:
	...
	bool LoadDataFromMySQL(CDataBaseLayerDataSource& dataSource);
	bool LoadDataFromDatabase(CDataBaseLayerDataSource& dataSource);
