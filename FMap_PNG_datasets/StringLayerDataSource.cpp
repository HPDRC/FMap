...
CShape*  CStringLayerDataSource::getRecord(long lRecord, CStringArray& aPropertyFields)
{
  ...
  // convert string to shape object , convert string to float for coordinate 
	...
	*/
	...
	pShape->m_aProperties.SetSize(20);
	...
	pShape->m_aProperties[17] = "";			//("CITYNAME") );//city name
	pShape->m_aProperties[18] = "";			//("CITYNAME") );//city name
	pShape->m_aProperties[19] = "";			//("CITYNAME") );//city name
	//pShape->m_aProperties[20] = "";			//("CITYNAME") );//city name
