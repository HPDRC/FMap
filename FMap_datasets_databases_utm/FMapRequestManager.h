...
private:
	bool isXML, isKMLReq, isKMLUTMReq, isGMLReq, isGMLUTMReq, 
		isAtlasReq, isAtlasUTMReq, isUTM, isTransGIF, isGIF, isHighlight, isTxt, isNorthHemisphere;
...
public:
	...
	bool hasFALayers(std::string overlay/*, bool& hasFAOwner, bool& hasFAADDR*/);
	bool hasFAParcel(std::string overlay);
	void addFALayers(std::string overlay);
